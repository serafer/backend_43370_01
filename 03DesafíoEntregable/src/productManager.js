...
// const manager = new ProductManager('./src/managers/products.json');
...
//   await manager.addProduct(productTest1)
//   await manager.addProduct(productTest3)
//   await manager.addProduct(productTest4)
//   await manager.addProduct(productTest5)
//   await manager.addProduct(productTest6)
//   await manager.addProduct(productTest7)
//   await manager.addProduct(productTest8)
//   await manager.addProduct(productTest9)
//   await manager.addProduct(productTest10)
//   await manager.addProduct(productTest11)
